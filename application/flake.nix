...
# along with this program.  If not, see <https://www.gnu.org/licenses/>.
{
  ...
  inputs = rec {
    ...
    pythoneda-shared-artifact-shared = {
      ...
      url = "github:pythoneda-shared-artifact/shared-artifact/0.0.7?dir=shared";
    };
    pythoneda-shared-pythoneda-banner = {
      inputs.nixos.follows = "nixos";
      inputs.flake-utils.follows = "flake-utils";
  ...
  outputs = inputs:
    ...
    flake-utils.lib.eachDefaultSystem (system:
      let
        ...
        repo = "application";
        version = "0.0.7";
        sha256 = "0qm2hs6hljfxmg2kzz6vrh35glqqgcflf7zn5fc1qw1p9ljr0v91";
        pname = "${org}-${repo}";
        ...
        pythoneda-shared-pythoneda-application-for = { python
          , pythoneda-shared-artifact-shared, pythoneda-shared-pythoneda-banner
          , pythoneda-shared-pythoneda-domain
          , pythoneda-shared-pythoneda-infrastructure }:
          let
